    ...
    const theme = {
        button: {
            styles: {
                ...
                sizes: {
                    sm: { fontSize: "text-sm", borderRadius: "rounded-full" },
        ...
        menu: {
            styles: { base: { item: { initial: { borderRadius: "rounded", color: "", pb: "", pt: "", px: "" } }, menu: { color: "" } } },
        },
        navbar: {
            styles: { base: { navbar: { initial: { px: "", py: "py-[8.35px]" } } }, variants: { filled: { white: { color: "" } } } },
        },
